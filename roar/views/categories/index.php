<?php echo $header; ?>
	...
	<a href="<?php echo Uri::to('categories/add'); ?>"><?php echo __('categories.create_category', 'Create a new category'); ?></a></h1>
	...
	<section class="content">
		...
		<ul class="list">
			...
			<li>
				<a href="<?php echo Uri::to('categories/edit/' . $category->id); ?>">
